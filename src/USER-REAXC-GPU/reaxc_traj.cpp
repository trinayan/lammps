...
extern "C" void Output_Sync_Lists( reax_list *host_list, reax_list *device_list, int type );
		...
		output_controls *out_control, mpi_datatypes *mpi_data )
{
	...
	l_bond = (reax_list *) malloc(sizeof(reax_list));
	l_three_body = (reax_list *) malloc(sizeof(reax_list));
