...
void Init_Forces_noQEq( reax_system *system, control_params *control,
	...
	for( i = 0; i < system->N; ++i ) {
		...
		//printf("%d,%d,%d,%d,%d\n", i,j,workspace->bond_mark[i],workspace->bond_mark[j],btop_i);



		///printf("%d,%d,%d,%d,%d,%d,%d\n", i,j,workspace->bond_mark[i],workspace->bond_mark[j],btop_i,start_i,end_i);
		...
		int start_index_bonds = Start_Index( i, bonds);
