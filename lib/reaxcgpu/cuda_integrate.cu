...
void update_velocity_part1( reax_system *system, real dt )
{
    ...
    hipLaunchKernelGGL(k_update_velocity_1, dim3(blocks), dim3(DEF_BLOCK_SIZE ), 0, 0,  system->d_my_atoms, system->reax_param.d_sbp, dt, system->n );
...
void update_velocity_part2( reax_system *system, real dt )
{
    ...
    hipLaunchKernelGGL(k_update_velocity_2, dim3(blocks), dim3(DEF_BLOCK_SIZE ), 0, 0,  system->d_my_atoms, system->reax_param.d_sbp, dt, system->n );
    hipDeviceSynchronize( );
    cudaCheckError( );
}
...
void nhNVT_update_velocity_part1( reax_system *system, real dt )
{
    ...
    hipLaunchKernelGGL(k_nhNVT_update_velocity_1, dim3(blocks), dim3(DEF_BLOCK_SIZE ), 0, 0,  system->d_my_atoms, system->reax_param.d_sbp, dt, system->n );
    hipDeviceSynchronize( );
    cudaCheckError( );
}
...
void nhNVT_update_velocity_part2( reax_system *system, storage *workspace, real dt, real v_xi )
{
    ...
    hipLaunchKernelGGL(k_nhNVT_update_velocity_2, dim3(blocks), dim3(DEF_BLOCK_SIZE ), 0, 0,  system->d_my_atoms, workspace->v_const, system->reax_param.d_sbp, dt, v_xi, system->n );
    hipDeviceSynchronize( );
    cudaCheckError( );
}
       ...
       real dt, real v_xi_old, real * d_my_ekin, real * d_total_my_ekin )
{
    ...
    hipLaunchKernelGGL(k_nhNVT_update_velocity_3, dim3(blocks), dim3(DEF_BLOCK_SIZE ), 0, 0,  system->d_my_atoms, workspace->v_const, system->reax_param.d_sbp, dt, v_xi_old, d_my_ekin, system->n );
    hipDeviceSynchronize( );
    cudaCheckError( );
...
void bNVT_scale_velocities( reax_system *system, real lambda )
{
    ...
    hipLaunchKernelGGL(k_bNVT_scale_velocities, dim3(blocks), dim3(DEF_BLOCK_SIZE ), 0, 0,  system->d_my_atoms, lambda, system->n );
    hipDeviceSynchronize( );
    cudaCheckError( );
}
...
void bNVP_scale_velocities( reax_system *system, real lambda, rvec mu )
{
    ...
    hipLaunchKernelGGL(k_bNVP_scale_velocities, dim3(blocks), dim3(DEF_BLOCK_SIZE ), 0, 0,  system->d_my_atoms, lambda, mu[0], mu[1], mu[2], system->n );
    hipDeviceSynchronize( );
    cudaCheckError( );
}
